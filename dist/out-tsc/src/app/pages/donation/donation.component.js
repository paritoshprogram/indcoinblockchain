...
var CreateDonationComponent = /** @class */ (function () {
    function CreateDonationComponent(blockchainService, router) {
    ...
    CreateDonationComponent.prototype.ngOnInit = function () {
    };
    CreateDonationComponent.prototype.createTransaction = function () {
    ...
    CreateDonationComponent = __decorate([
        Component({
    ...
    return CreateDonationComponent;
}());
export { CreateDonationComponent };
